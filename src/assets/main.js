     /**
      ...
      function loadDefaultValues() {
        ...
        $("[id^=alt-][id$=-style-color-5]").val(default_style_color_5);

        $("[id^=alt-][id$=-name-transform]").prop(
          "checked",
        ...
        $("[id^=alt-][id$=-info-transform]").prop(
          "checked",
          default_info_transform
        );
      ...
      var alt_5_active_time_monitor;
      var alt_5_inactive_time_monitor;
      ...
      var alt_5_logo_default = "../logos/logo_5.png";
      ...
      var alt_5_style = default_style;
      var alt_5_inverse_ratio = default_inverse_ratio;
      var alt_5_name_size;
      var alt_5_info_size;
      var alt_5_size;
      var alt_5_line_spacing;
      var alt_5_margin_h;
      var alt_5_margin_v;
      var alt_5_shadows;
      var alt_5_font;
      var alt_5_logo_size;
      var alt_5_shadow_amount;
      var alt_5_corners;
      var alt_5_border_thickness_amount;
      ...
      var hotkeySwitch5Old = hotkeySwitch5;
      ...
      var hotkeyAlt5Slot1Old = hotkeyAlt5Slot1;
      var hotkeyAlt5Slot2Old = hotkeyAlt5Slot2;
      var hotkeyAlt5Slot3Old = hotkeyAlt5Slot3;
      var hotkeyAlt5Slot4Old = hotkeyAlt5Slot4;
      var hotkeyAlt5Slot5Old = hotkeyAlt5Slot5;
      var hotkeyAlt5Slot6Old = hotkeyAlt5Slot6;
      var hotkeyAlt5Slot7Old = hotkeyAlt5Slot7;
      var hotkeyAlt5Slot8Old = hotkeyAlt5Slot8;
      var hotkeyAlt5Slot9Old = hotkeyAlt5Slot9;
      var hotkeyAlt5Slot10Old = hotkeyAlt5Slot10;

      var alt_1_turnoff = false;
      var alt_2_turnoff = false;
      var alt_3_turnoff = false;
      var alt_4_turnoff = false;
      var alt_5_turnoff = false;
      ...
      var theme = localStorage.getItem("theme")
        ...
        : "dark";
      $("head").append(
        '<link rel="stylesheet" href="../common/css/themes/' +
          theme +
          '/theme.css"/>'
      );
      ...
      $("#add-new-font").click(function () {
        ...
        if (font_name_to_add && font_url_to_add) {
          ...
          var font_name_to_add_clean = font_name_to_add.replace(
            "font-family: ",
            ""
          );
          ...
          var font_url_to_add_clean = font_url_to_add_clean.replace(
            " </style>",
            ""
          );
          ...
          localStorage.setItem(
            "font-name-added-" + howMany,
            font_name_to_add_clean
          );
          localStorage.setItem(
            "font-url-added-" + howMany,
            font_url_to_add_clean
          );
        }
      });
      ...
      function checkSwitches() {
        ...
        if (masterSwitchIsOn) {
          ...
          //Switch 5
          if (document.getElementById("lower-thirds-switch5").checked) {
            if (
              alt_5_active_time_monitor >= 0 &&
              alt_5_inactive_time_monitor == 0 &&
              alt_5_name &&
              alt_5_info
            ) {
              document
                .getElementById("alt-5-config-content")
                .classList.remove("inactive");
              document
                .getElementById("alt-5-config-content")
                .classList.add("active");
              ...
              document
                ...
                .classList.add("inactive");
              //check if autoload is active and jump to next slot
              if (alt_5_autoload && alt_5_jumpnext) {
                alt_5_jumpnext = false;
                jumpNextSlot(
                  "#alt-5-memory-slots",
                  "#alt-5-name",
                  "#alt-5-info",
            ...
            document.getElementById("alt-5-config-content").className = "";
          }
        } else {
      ...
      function checkHotkeys() {
        ...
        if (hotkeySwitch5 != hotkeySwitch5Old) {
          if (document.getElementById("lower-thirds-switch5").checked) {
            $("#lower-thirds-switch5").prop("checked", false).change();
          } else {
            $("#lower-thirds-switch5").prop("checked", true).change();
          }
          hotkeySwitch5Old = hotkeySwitch5;
        }
        ...
        //Memory Slots triggers LT5
        if (hotkeyAlt5Slot1 != hotkeyAlt5Slot1Old) {
          loadSlot(
            "#alt-5-name",
            "#alt-5-info",
            "#alt-5-logo-preview",
          ...
          hotkeyAlt5Slot1Old = hotkeyAlt5Slot1;
        }
        if (hotkeyAlt5Slot2 != hotkeyAlt5Slot2Old) {
          loadSlot(
            "#alt-5-name",
            "#alt-5-info",
            "#alt-5-logo-preview",
          ...
          hotkeyAlt5Slot2Old = hotkeyAlt5Slot2;
        }
        if (hotkeyAlt5Slot3 != hotkeyAlt5Slot3Old) {
          loadSlot(
            "#alt-5-name",
            "#alt-5-info",
            "#alt-5-logo-preview",
          ...
          hotkeyAlt5Slot3Old = hotkeyAlt5Slot3;
        }
        if (hotkeyAlt5Slot4 != hotkeyAlt5Slot4Old) {
          loadSlot(
            "#alt-5-name",
            "#alt-5-info",
            "#alt-5-logo-preview",
          ...
          hotkeyAlt5Slot4Old = hotkeyAlt5Slot4;
        }
        if (hotkeyAlt5Slot5 != hotkeyAlt5Slot5Old) {
          loadSlot(
            "#alt-5-name",
            "#alt-5-info",
            "#alt-5-logo-preview",
          ...
          hotkeyAlt5Slot5Old = hotkeyAlt5Slot5;
        }
        if (hotkeyAlt5Slot6 != hotkeyAlt5Slot6Old) {
          loadSlot(
            "#alt-5-name",
            "#alt-5-info",
            "#alt-5-logo-preview",
          ...
          hotkeyAlt5Slot6Old = hotkeyAlt5Slot6;
        }
        if (hotkeyAlt5Slot7 != hotkeyAlt5Slot7Old) {
          loadSlot(
            "#alt-5-name",
            "#alt-5-info",
            "#alt-5-logo-preview",
          ...
          hotkeyAlt5Slot7Old = hotkeyAlt5Slot7;
        }
        if (hotkeyAlt5Slot8 != hotkeyAlt5Slot8Old) {
          loadSlot(
            "#alt-5-name",
            "#alt-5-info",
            "#alt-5-logo-preview",
          ...
          hotkeyAlt5Slot8Old = hotkeyAlt5Slot8;
        }
        if (hotkeyAlt5Slot9 != hotkeyAlt5Slot9Old) {
          loadSlot(
            "#alt-5-name",
            "#alt-5-info",
            "#alt-5-logo-preview",
          ...
          hotkeyAlt5Slot9Old = hotkeyAlt5Slot9;
        }
        if (hotkeyAlt5Slot10 != hotkeyAlt5Slot10Old) {
          loadSlot(
            "#alt-5-name",
            "#alt-5-info",
            "#alt-5-logo-preview",
          ...
          hotkeyAlt5Slot10Old = hotkeyAlt5Slot10;
        }
      }
      ...
      function okResetPopup() {
        ...
        $(".logo-storable").each(function () {
          ...
          if (id == "alt-5-logo-preview" || id == "alt-5-logo-default") {
            value = alt_5_logo_default;
          }
      ...
      function okLogoPopup(logo, logo_default) {
        ...
        if (src) {
          ...
          if (
            logo == logo_default &&
            $("#" + alt_logo_preview).hasClass("default")
          ) {
            $("#" + alt_logo_preview)
      ...
      function jumpNextSlot(memory_slot, name, info, logo, alt_waiting_time) {
        ...
        if (to_load && to_load > 0) {
          $("ul" + memory_slot + " li:nth-child(" + to_load + ")").each(
            function () {
      ...
      $("#alt-5-clean-inputs").click(function () {
        $("#alt-5-name:text").val("").change();
        $("#alt-5-info:text").val("").change();
        var alt_logo_default = $("#alt-5-logo-default").attr("src");
        $("#alt-5-logo-preview").attr("src", alt_logo_default).change();
      });
      ...
      function getAppearance() {
        ...
        alt_5_style = $("#alt-5-style").val() || default_style;
        $("#alt-5-style").val(alt_5_style);
        ...
        alt_5_inverse_ratio =
          $("#alt-5-inverse-ratio").val() || default_inverse_ratio;
        alt_5_name_size = 1 + alt_5_inverse_ratio * 0.1;
        alt_5_info_size = 2 - alt_5_inverse_ratio * 0.1;

        //Line Spacing
        alt_1_line_spacing =
          $("#alt-1-line-spacing").val() || default_line_spacing;
        alt_2_line_spacing =
          $("#alt-2-line-spacing").val() || default_line_spacing;
        alt_3_line_spacing =
          $("#alt-3-line-spacing").val() || default_line_spacing;
        alt_4_line_spacing =
          $("#alt-4-line-spacing").val() || default_line_spacing;
        alt_5_line_spacing =
          $("#alt-5-line-spacing").val() || default_line_spacing;
        ...
        alt_5_size = $("#alt-5-size").val() || default_size;

        //Logo Size
        alt_1_logo_size =
          Number($("#alt-1-logo-size").val()) * 0.25 + 3.5 ||
          default_logo_size_em;
        alt_2_logo_size =
          Number($("#alt-2-logo-size").val()) * 0.25 + 3.5 ||
          default_logo_size_em;
        alt_3_logo_size =
          Number($("#alt-3-logo-size").val()) * 0.25 + 3.5 ||
          default_logo_size_em;
        alt_4_logo_size =
          Number($("#alt-4-logo-size").val()) * 0.25 + 3.5 ||
          default_logo_size_em;
        alt_5_logo_size =
          Number($("#alt-5-logo-size").val()) * 0.25 + 3.5 ||
          default_logo_size_em;
        ...
        alt_5_shadow_amount =
          $("#alt-5-shadow-amount").val() * 0.1 || default_shadow_amount_em;

        //Background Corners
        alt_1_corners =
          Number($("#alt-1-corners").val()) * 0.25 || default_corners;
        alt_2_corners =
          Number($("#alt-2-corners").val()) * 0.25 || default_corners;
        alt_3_corners =
          Number($("#alt-3-corners").val()) * 0.25 || default_corners;
        alt_4_corners =
          Number($("#alt-4-corners").val()) * 0.25 || default_corners;
        alt_5_corners =
          Number($("#alt-5-corners").val()) * 0.25 || default_corners;
        ...
        alt_4_border_thickness_amount =
          ...
          default_border_thickness_amount;
        alt_5_border_thickness_amount =
          $("#alt-5-border-thickness-amount").val() ||
          default_border_thickness_amount;
        ...
        alt_5_margin_h = $("#alt-5-margin-h").val() || default_margin_h;
        alt_5_margin_v = $("#alt-5-margin-v").val() || default_margin_v;
      ...
      function styleRestrictions() {
        switch (alt_1_style) {
          ...
          case "2":
            ...
            // document.getElementById("alt-1-background").classList.remove("locked");
            $(
              "#alt-1-style-border-color-appearance > :nth-child(3)"
        ...
        switch (alt_2_style) {
          ...
          case "2":
            ...
            $(
              "#alt-2-style-border-color-appearance > :nth-child(3)"
            ).removeClass("disabled");
            break;
          case "3":
            //Disable: - | Enable: Logo, align center;
        ...
        switch (alt_3_style) {
          ...
          case "2":
            ...
            $(
              "#alt-3-style-border-color-appearance > :nth-child(3)"
            ).removeClass("disabled");
            break;
          case "3":
            //Disable: - | Enable: Logo, align center;
        ...
        switch (alt_4_style) {
          ...
          case "2":
            ...
            $(
              "#alt-4-style-border-color-appearance > :nth-child(3)"
            ).removeClass("disabled");
            break;
          case "3":
            //Disable: - | Enable: Logo, align center;
        ...
        switch (alt_5_style) {
          case "1":
            //Disable: align center | Enable: logo;
            document.getElementById("alt-5-align-center").disabled = true;
            if (document.getElementById("alt-5-align-center").checked) {
              $("#alt-5-align-left").prop("checked", true).change();
            }
            document.getElementById("alt-5-logo").disabled = false;
            document.getElementById("alt-5-logo-size").disabled = false;
            $("#alt-5-style-border-color-appearance > :nth-child(3)").addClass(
              "disabled"
            );
            break;
          case "2":
            //Disable: logo | Enable: align center;
            document.getElementById("alt-5-align-center").disabled = false;
            document.getElementById("alt-5-logo").disabled = true;
            if (document.getElementById("alt-5-logo").checked) {
              $("#alt-5-logo").prop("checked", false).change();
            }
            $(
              "#alt-5-style-border-color-appearance > :nth-child(3)"
            ).removeClass("disabled");
            break;
          case "3":
            //Disable: - | Enable: Logo, align center;
            ...
            document.getElementById("alt-5-logo").disabled = false;
            document.getElementById("alt-5-logo-size").disabled = true;
            $(
              "#alt-5-style-border-color-appearance > :nth-child(3)"
            ).removeClass("disabled");
            break;
      ...
      bcr.onmessage = function (ev) {
        ...
        if (received_data.resend) {
          ...
          alt_5_active_time_monitor = received_data.activeTime5_to_send;
          alt_5_inactive_time_monitor = received_data.inactiveTime5_to_send;
          ...
          document.getElementById("alt-5-active-time-monitor").innerHTML =
            alt_5_active_time_monitor;
          document.getElementById("alt-5-inactive-time-monitor").innerHTML =
            alt_5_inactive_time_monitor;
          ...
          alt_5_turnoff = received_data.alt_5_turnoff;
          ...
          if (alt_5_turnoff && $("#lower-thirds-switch5").is(":checked")) {
            $("#lower-thirds-switch5").prop("checked", false).change();
          }
      ...
      function function_send() {
        ...
        global_lock_active = document.getElementById("global-lock-active")
          .checked
          ? true
          : false;
        ...
        alt_4_lock_active = document.getElementById("alt-4-lock-active").checked
          ? true
          : false;
        alt_5_lock_active = document.getElementById("alt-5-lock-active").checked
          ? true
          : false;
        ...
        alt_5_name = $("#alt-5-name:text").val();
        alt_5_info = $("#alt-5-info:text").val();
        alt_5_name_color = $("#alt-5-name-color:text").val();
        alt_5_info_color = $("#alt-5-info-color:text").val();
        alt_5_style_color_1 = $("#alt-5-style-color-1:text").val();
        alt_5_style_color_2 = $("#alt-5-style-color-2:text").val();
        alt_5_style_color_3 = $("#alt-5-style-color-3:text").val();
        alt_5_style_color_5 = $("#alt-5-style-color-5:text").val();
        alt_5_animation_time = $("#alt-5-animation-time").val();
        if (alt_5_lock_active) {
          alt_5_active_time = Infinity;
        } else {
          alt_5_active_time = $("#alt-5-active-time").val();
        }
        alt_5_inactive_time = $("#alt-5-inactive-time").val();
        alt_5_logo_image = $("#alt-5-logo-preview").attr("src");
        ...
        alt_5_waiting_time = alt_5_animation_time || global_animation_time;
        ...
        alt_4_autoload = document.getElementById("alt-4-autoload").checked
          ? true
          : false;
        alt_5_autoload = document.getElementById("alt-5-autoload").checked
          ? true
          : false;
        ...
        alt_1_autotrigger =
          document.getElementById("alt-1-autotrigger").checked;
        alt_2_autotrigger =
          document.getElementById("alt-2-autotrigger").checked;
        alt_3_autotrigger =
          document.getElementById("alt-3-autotrigger").checked;
        alt_4_autotrigger =
          document.getElementById("alt-4-autotrigger").checked;
        alt_5_autotrigger =
          document.getElementById("alt-5-autotrigger").checked;
        ...
        alt_4_oneshot = document.getElementById("alt-4-oneshot").checked
          ? true
          : false;
        alt_5_oneshot = document.getElementById("alt-5-oneshot").checked
          ? true
          : false;
        ...
        if (document.getElementById("alt-5-preview").checked == false) {
          alt_5_preview = "false";
        } else {
          alt_5_preview = "true";
        }
        ...
        if (document.getElementById("alt-5-logo").checked == false) {
          alt_5_logo_switch = "false";
          $("#alt-5-logo-size").addClass("disable");
          $(
            "#alt-5-config-content > .first-edit-container > .logo-container"
          ).addClass("hide");
        } else {
          alt_5_logo_switch = "true";
          $("#alt-5-logo-size").removeClass("disable");
          $(
            "#alt-5-config-content > .first-edit-container > .logo-container"
          ).removeClass("hide");
        }
        ...
        if (document.getElementById("alt-5-background").checked == false) {
          alt_5_background_switch = "false";
          $("#alt-5-style-color-appearance").addClass("disable");
        } else {
          alt_5_background_switch = "true";
          $("#alt-5-style-color-appearance").removeClass("disable");
        }
        ...
        $(".twin-checkbox").each(function () {
          ...
          var twin_checkboxes = $(
            "input[type=checkbox][name=" + twin_name + "]"
          );
        ...
        if (document.getElementById("alt-5-border-color").checked == false) {
          alt_5_border_switch = "false";
          $("#alt-5-border-thickness-amount").addClass("disable");
          $("#alt-5-style-border-color-appearance").addClass("disable");
        } else {
          alt_5_border_switch = "true";
          $("#alt-5-border-thickness-amount").removeClass("disable");
          $("#alt-5-style-border-color-appearance").removeClass("disable");
        }
        ...
        if (document.getElementById("alt-5-shadows").checked == false) {
          alt_5_shadows = "false";
          $("#alt-5-shadow-amount").addClass("disable");
        } else {
          alt_5_shadows = "true";
          $("#alt-5-shadow-amount").removeClass("disable");
        }
        ...
        if (document.getElementById("alt-5-name-transform").checked == false) {
          alt_5_name_transform = "normal";
        } else {
          alt_5_name_transform = "uppercase";
        }
        if (document.getElementById("alt-5-name-weight").checked == false) {
          alt_5_name_weight = "lighter";
        } else {
          alt_5_name_weight = "bold";
        }
        ...
        if (document.getElementById("alt-5-info-transform").checked == false) {
          alt_5_info_transform = "normal";
        } else {
          alt_5_info_transform = "uppercase";
        }
        if (document.getElementById("alt-5-info-weight").checked == false) {
          alt_5_info_weight = "lighter";
        } else {
          alt_5_info_weight = "bold";
        }
        ...
        var font_id_5 = document.getElementById("alt-5-font");
        var alt_5_font = font_id_5.options[font_id_5.selectedIndex].value;
		...
		var alt_5_align = $("input[name=alt-5-align]:checked").val();
        if (!alt_5_align) {
          $("#alt-5-align-left").prop("checked", true).change();
        }
        ...
        if (global_oneshot) {
          document
            .getElementById("global-inactive-time")
        ...
        if (alt_1_oneshot) {
          document
            .getElementById("alt-1-inactive-time")
            .classList.add("disable");
        } else {
          document
            .getElementById("alt-1-inactive-time")
        ...
        if (alt_2_oneshot) {
          document
            .getElementById("alt-2-inactive-time")
            .classList.add("disable");
        } else {
          document
            .getElementById("alt-2-inactive-time")
        ...
        if (alt_3_oneshot) {
          document
            .getElementById("alt-3-inactive-time")
            .classList.add("disable");
        } else {
          document
            .getElementById("alt-3-inactive-time")
        ...
        if (alt_4_oneshot) {
          document
            .getElementById("alt-4-inactive-time")
            .classList.add("disable");
        } else {
          document
            .getElementById("alt-4-inactive-time")
        ...
        if (alt_5_oneshot) {
          document
            .getElementById("alt-5-inactive-time")
            .classList.add("disable");
        } else {
          document
            .getElementById("alt-5-inactive-time")
        ...
        if (global_lock_active) {
          document
            .getElementById("global-active-time")
            .classList.add("disable");
        } else {
          document
            .getElementById("global-active-time")
        ...
        if (alt_1_lock_active) {
          ...
          document
            .getElementById("alt-1-active-time")
            .classList.remove("disable");
        ...
        if (alt_2_lock_active) {
          ...
          document
            .getElementById("alt-2-active-time")
            .classList.remove("disable");
        }
        if (alt_3_lock_active) {
          ...
          document
            .getElementById("alt-3-active-time")
            .classList.remove("disable");
        }
        if (alt_4_lock_active) {
          ...
          document
            .getElementById("alt-4-active-time")
            .classList.remove("disable");
        }
        if (alt_5_lock_active) {
          document.getElementById("alt-5-active-time").classList.add("disable");
        } else {
          document
            .getElementById("alt-5-active-time")
            .classList.remove("disable");
        }
        ...
        if (
          alt_5_animation_time ||
          (alt_5_active_time && alt_5_active_time != "Infinity") ||
          alt_5_inactive_time ||
          alt_5_lock_active ||
          alt_5_oneshot
        ) {
          $("#alt-5-custom-times").children(".icon-btn").addClass("active");
        } else {
          $("#alt-5-custom-times").children(".icon-btn").removeClass("active");
        }
        ...
        bc.postMessage({
          ...
          alt_5_name_size,
          alt_5_info_size,
          alt_5_name_transform,
          alt_5_info_transform,
          alt_5_name_weight,
          alt_5_info_weight,
          alt_5_name_color,
          alt_5_info_color,
      ...
      function settingsTooltips() {
        const tooltip = {
          ...
          global_inactive_time:
            "How long the LT is inactive.<br>Default: 420 sec.",
        ...
        $("#global-animation-time").attr(
          "title",
          tooltip.global_animation_time
        );
        ...
        $("#fonts-options")
          .children()
          .first()
          .attr("title", tooltip.custom_fonts);
        $(".logos-options")
          .children()
          .first()
          .attr("title", tooltip.default_logos);
      ...
      function loadData() {
        ...
        $(".logo-storable").each(function () {
          ...
          if (value != "undefined" && value != "") {
            ...
            if (id == "alt-5-logo-preview" || id == "alt-5-logo-default") {
              $(this).attr("src", alt_5_logo_default);
            }
          }
        });
